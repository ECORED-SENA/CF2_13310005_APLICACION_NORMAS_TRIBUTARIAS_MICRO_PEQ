export default {
  global: {
    ...
    descripcionCurso:
      'Las normas de tipo tributario son importantes para el recaudo de ingresos en Colombia, esto con el propósito fundamental de poder solventar los gastos públicos. A partir del estatuto tributario, el decreto único reglamentario y demás reformas tributarias que se puedan presentar, se establecen los impuestos y las tarifas porcentuales a pagar por cada contribuyente, según cada caso.',
  ...
  menuPrincipal: {
    menu: [
      ...
      },
      {
        ...
        numero: '1',
        titulo: 'Responsabilidad tributaria',
        desarrolloContenidos: true,
        subMenu: [
          {
            icono: 'far fa-file-alt',
          ...
          },
          {
            icono: 'far fa-file-alt',
            numero: '1.5',
            titulo: 'Condiciones de liquidación',
            hash: 't_1_5',
          },
        ],
      },

      {
        ...
        subMenu: [
          ...
          },
          {
            icono: 'far fa-file-alt',
            numero: '2.2',
            titulo: 'Decreto único reglamentario 1625 de 2016',
            hash: 't_2_2',
          },
          {
            icono: 'far fa-file-alt',
            numero: '2.3',
            titulo: 'Otras normas del orden nacional y municipal',
            hash: 't_2_3',
          },
          {
            icono: 'far fa-file-alt',
            numero: '2.4',
            titulo: 'Otras responsabilidades tributarias',
            hash: 't_2_4',
          },
        ],
      },
      {
        ...
        icono: 'far fa-file-alt',
        numero: '3',
        titulo: 'Otras disposiciones tributarias',
        desarrolloContenidos: true,
        subMenu: [
          {
            icono: 'far fa-file-alt',
          ...
          },
          {
            icono: 'far fa-file-alt',
            numero: '3.2',
            titulo: 'Tipos de informes técnicos',
            hash: 't_3_2',
          },
          {
            icono: 'far fa-file-alt',
            numero: '3.3',
            titulo: 'Tributos aduaneros',
            hash: 't_3_3',
          },
        ],
      },
